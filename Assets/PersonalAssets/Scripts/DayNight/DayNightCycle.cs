...
public class DayNightCycle : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        _timeOfDay = (((float)System.DateTime.Now.Hour + ((float)System.DateTime.Now.Minute / 60f)) / 24f);
    ...
    {
        float time = ((((float)System.DateTime.Now.Hour * 3600f) + ((float)System.DateTime.Now.Minute * 60f) + (float)System.DateTime.Now.Second) / (targetDayLength * 60));  //elapsedTime / (targetDayLength * 60);
